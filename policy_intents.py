...
POLICY_CONTROL_MAP = {
    ...
    "ISMS Roles and Responsibilities": ["ISO_5.3", "A.5.2", "CC1.3"],
    ...
    "Document Control Procedure": ["ISO_7.5", "A.5.37"],
    ...
    "Asset Management Policy": ["A.5.9", "A.5.10", "A.5.11", "CC6.5"],
    ...
    "Data Protection and Privacy Policy": ["A.5.34", "A.8.11", "CC6.5"],
