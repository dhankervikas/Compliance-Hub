    ...
    <AuthProvider>
      <Router>
        <Routes>
          ...
          <Route path="/policies" element={<ProtectedRoute><ProtectedLayout><PolicyList /></ProtectedLayout></ProtectedRoute>} />
...
// ... inside Routes ...
          {/* REPORTS */}
          <Route path="/frameworks" element={<ProtectedRoute><ProtectedLayout><Dashboard /></ProtectedLayout></ProtectedRoute>} />
          <Route path="/trust-report" element={<ProtectedRoute><ProtectedLayout><TrustReport /></ProtectedLayout></ProtectedRoute>} />
          <Route path="/soa" element={<ProtectedRoute><ProtectedLayout><StatementOfApplicability /></ProtectedLayout></ProtectedRoute>} />
          <Route path="/auditor-portal" element={<ProtectedRoute><ProtectedLayout><AuditorPortal /></ProtectedLayout></ProtectedRoute>} />
          <Route path="/ai-compliance" element={<ProtectedRoute><ProtectedLayout><ComplianceHealth /></ProtectedLayout></ProtectedRoute>} />
