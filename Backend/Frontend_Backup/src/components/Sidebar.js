...
import {
    ...
    Monitor, Briefcase, File,
    Layers, CheckSquare, HardDrive, Wifi, Lock, Activity
} from 'lucide-react';
    ...
    const navGroups = [
        ...
        },
        {
            ...
            items: [
                ...
                { label: 'Statement of Applicability', path: '/soa', icon: FileText },
                { label: 'Auditor Portal', path: '/auditor-portal', icon: Users },
                { label: 'AI Compliance Health', path: '/ai-compliance', icon: Activity }
            ]
        },
        {
            key: 'manage',
