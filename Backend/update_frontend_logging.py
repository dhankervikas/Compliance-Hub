...
frontend_path = r"..\..\Frontend\src\contexts\AuthContext.js"

content = r"""import React, { createContext, useContext, useState, useEffect } from 'react';
...
export const AuthProvider = ({ children }) => {
  ...
  const login = async (username, password) => {
    ...
    try {
      ...
      console.log("[AuthContext] Sending POST to /api/v1/auth/login...");
      ...
      console.log("[AuthContext] Token extracted:", access_token);
...
try:
    with open(frontend_path, "w", encoding="utf-8") as f:
        f.write(content)
    print(f"SUCCESS: Updated {os.path.abspath(frontend_path)}")
